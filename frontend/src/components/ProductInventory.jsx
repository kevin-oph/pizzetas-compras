  ...
  return (
    <div className="p-3 md:p-8 max-w-4xl mx-auto bg-gray-50 min-h-screen pb-24">
      <div className="mb-6">
        ...
        <p className="text-xs md:text-sm text-slate-500">Stock actual y niveles ideales por proveedor</p>
      </div>

      {/* Barra de búsqueda rápida integrada */}
              ...
              {isOpen && (
                <div className="p-3 md:p-4 divide-y divide-slate-100">
                  {filteredItems.map((item) => {
                    const isLow = item.current_stock < item.ideal_stock;
                    return (
